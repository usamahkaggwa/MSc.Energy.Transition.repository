...
for i = 1:size(tou_periods, 1)
    ...
    if end_h <= start_h
        end_h = end_h + 24;  % Handle wrap-around for 20:00-24:00
...
% Display ToU Tariffs
fprintf('\nTime-of-Use (ToU) Pricing Tariffs ($/MWh):\n');
fprintf('Period            | Grid  | DR\n');
fprintf('---------------------------------\n');
fprintf('Off-Peak (00:00-07:00, 20:00-24:00) | %.0f    | %.0f\n', tou_tariffs_grid(1), tou_tariffs_dr(1));
fprintf('Shoulder (07:00-17:00)              | %.0f    | %.0f\n', tou_tariffs_grid(2), tou_tariffs_dr(2));
fprintf('Peak (17:00-20:00)                  | %.0f    | %.0f\n', tou_tariffs_grid(3), tou_tariffs_dr(3));
...
for t = 1:n_hours
    ...
    scaled_cost = total_cost(t) * 10000; %% scale....
    scaled_emission = total_emission(t) * 10000; %% scale ....10,000
...
repository = repository * 10000; %scaling...
...
sgtitle('24-Hour Load Profiles with ToU/DR Reduction');
...
%%TIME of USE PRICING __SUBPLOTS
figure('Position', [100, 100, 1200, 800]);
% Time-of-Use Pricing
subplot(2,2,1);
